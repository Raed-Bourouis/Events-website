    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-column">
          <h3>Subscribe</h3>
          <form>
            <input type="email" placeholder="Enter your email" style={{ padding: '10px', width: '80%', borderRadius: '4px', border: 'none', marginBottom: '10px' }} />
            <button type="submit" style={{ padding: '10px 20px', borderRadius: '4px', border: 'none', background: '#1e90ff', color: '#ffffff', cursor: 'pointer' }}>Subscribe</button>
          </form>
        </div>
